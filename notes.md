# Intro
This simple assignment will help give you a feel for what it is like to be a PTx
...
This is a fun toy assignment. Your submitted code will not be used by PTx.
...
Even though this is a tiny toy example, write your code pretending it is a larger project.
...
* Use a 3 pin slide switch to simulate the door sensor input.
